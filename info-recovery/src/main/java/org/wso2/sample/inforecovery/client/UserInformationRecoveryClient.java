...
import org.wso2.sample.inforecovery.controller.AccountOverviewController;
...
public class UserInformationRecoveryClient {
    ...
    private static final Log log = LogFactory.getLog(UserInformationRecoveryClient.class);
