...
public class VerificationController extends HttpServlet {
    ...
    private static final Log log = LogFactory.getLog(VerificationController.class);
    ...
    public void init() {
        try {
            ...
            storeLoginURL = this.getServletConfig().getServletContext()
                    .getInitParameter("storeLoginURL");
