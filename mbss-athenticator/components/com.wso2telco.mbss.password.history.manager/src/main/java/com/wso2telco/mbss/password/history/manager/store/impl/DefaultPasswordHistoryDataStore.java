package com.wso2telco.mbss.password.history.manager.store.impl;

import com.wso2telco.mbss.password.history.manager.Constants;
...
import com.wso2telco.mbss.password.history.manager.util.PasswordHistoryDbUtil;
...
public class DefaultPasswordHistoryDataStore implements PasswordHistoryDataStore {
    ...
    public void store(User user, Object credential) throws
        ...
        try {
            connection = PasswordHistoryDbUtil.getIdentityDbConnection();
        ...
        try {
            ...
            try {
                PasswordHistoryDbUtil.closeResources(connection, prepStmt1, resultSet);
                PasswordHistoryDbUtil.closeResources(null, prepStmt2, null);
                PasswordHistoryDbUtil.closeResources(null, prepStmt3, null);
            } catch (SQLException e) {
                log.error(e.getMessage(), e);
            }
        }
    ...
    public void remove(User user) throws IdentityPasswordHistoryException {
        ...
        try {
            ...
            try {
                PasswordHistoryDbUtil.closeResources(connection, prepStmt, null);
            } catch (SQLException e) {
                log.error(e.getMessage(), e);
            }
        }
    ...
    public boolean validate(User user, Object credential) throws IdentityPasswordHistoryException {
        ...
        try {
            ...
            try {
                PasswordHistoryDbUtil.closeResources(connection, prepStmt, resultSet);
            } catch (SQLException e) {
                log.error(e.getMessage(), e);
            }
        }
