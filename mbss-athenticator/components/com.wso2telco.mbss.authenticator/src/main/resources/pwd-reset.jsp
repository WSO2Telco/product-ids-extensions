<%--
  ~ Copyright (c) 2018, WSO2Telco Inc. (http://www.wso2telco.com) All Rights Reserved.
  ~
...
<fmt:bundle basename="org.wso2.carbon.identity.application.authentication.endpoint.i18n.Resources">
    ...
    <div class="container-fluid body-wrapper">
        <div class="row">
            <div class="container col-xs-10 col-sm-8 col-md-8 col-lg-5 col-centered wr-content wr-login col-centered">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="container col-xs-10 col-sm-8 col-md-8 col-lg-5 col-centered wr-content wr-login col-centered">
                    <div>
                        <h2 class="wr-title padding-double white boarder-bottom-blue margin-none" style="background-color: #F27B21;">
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                           ...
                           <input id="repeatPassword" name="NEW_PWD_CONFIRMATION" type="password" class="form-control"
                            ...
                            <div class='form-row'>
                               <div class='col-md-12 form-group'>
                                 <button class='form-control' style="background-color: #F27B21; color: white; font-size: 1em;" type='submit' onclick="$('#loading').show();">Change password</button>
                               </div>
                        </div>
