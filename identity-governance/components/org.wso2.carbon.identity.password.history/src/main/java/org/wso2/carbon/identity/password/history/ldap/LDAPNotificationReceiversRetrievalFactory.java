 ...
 * under the License.
 */
package org.wso2.carbon.identity.password.history.ldap;

import org.wso2.carbon.identity.password.history.NotificationReceiversRetrieval;
...
public class LDAPNotificationReceiversRetrievalFactory implements NotificationReceiversRetrievalFactory {
    ...
    public static final String LDAP =
            "org.wso2.carbon.identity.password.history.ldap.LDAPNotificationReceiversRetrieval";
